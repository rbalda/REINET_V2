...
urlpatterns = patterns('',
                       ...
                       url(r'^EditarMiIncubacion[/]?$', 'incubacion.views.editar_mi_incubacion',
                           name='editar_incubacion'),
                       url(r'^AdminIncubacion[/]?$', 'incubacion.views.admin_ver_incubacion',
                           name='admin_ver_incubacion'),
                       ...
                       url(r'^AdminIncubada[/]?$', 'incubacion.views.admin_ver_incubada', name='admin_ver_incubada'),
                       url(r'^ConsultorIncubada[/]?$', 'incubacion.views.consultor_ver_incubada',
                           name='consultor_ver_incubada'),
                       url(r'^Incubada[/]?$', 'incubacion.views.usuario_ver_incubada', name='usuario_ver_incubada'),

                       url(r'^NotFound[/]?$', vista_404, name='NotFound'),
                       url(r'^AutocompletarConsultor[/]?$', Autocompletar_Consultor.as_view(),
                           name='AutocompletarConsultor'),
)
