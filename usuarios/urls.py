...
urlpatterns = patterns('',
        ...
        url(r'^BandejaDeEntrada[/]?$', 'usuarios.views.ver_bandeja_entrada', name='BandejaDeEntrada'),
        url(r'^BandejaDeEntradaInstitucion[/]?$', 'usuarios.views.ver_bandeja_entrada_institucion', name='BandejaDeEntradaInstitucion'),
        ...
        url(r'^verMensaje[/]?$', 'usuarios.views.verMensaje', name='verMensaje'),
        url(r'^verMensajeEnviado[/]?$', 'usuarios.views.verMensajeEnviado', name='verMensajeEnviado'),
        url(r'^verMensajeInstitucion[/]?$', 'usuarios.views.verMensajeInstitucion', name='verMensajeInstitucion'),
        url(r'^verMensajeEnviadoInstitucion[/]?$', 'usuarios.views.verMensajeEnviadoInstitucion', name='verMensajeEnviadoInstitucion'),
        url(r'^mensajesEnviados[/]?$', 'usuarios.views.mensajesEnviados', name='mensajesEnviados'),
